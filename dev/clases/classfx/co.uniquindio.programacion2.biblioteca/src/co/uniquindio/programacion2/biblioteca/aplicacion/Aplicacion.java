...
import co.uniquindio.programacion2.biblioteca.test.Test;
...
//		direccionBiblioteca = leerStringVentana("Ingrese la direccion de la biblioteca");
		...
		do {
			...
			case 2://consultar estudiante
				...
				resultado = validarIdentificacion(identificacionEstudiante);
			...
			case 5:
				...
				if(resultado == true) {
					...
					if (prestamoSolicitado != null) {
						imprimir("Codigo solicitado"+prestamoSolicitado.getCodigo());
					}
					else{
	...
	private static boolean validarIdentificacion(String identificacionEstudiante) {
