...
public class Biblioteca {
	...
	private void CargarArray() {
		...
		libro = new Libro("13","100 a�os de Soledad","Gabriel Garcia Marquez","Novela");
		listaLibros.add(libro);
	...
	public static Libro BuscarLibro(String id) {
		...
		for(Libro libro: listaLibros){
			...
			if(libro.getIdentificacion().equals(id)){
				libro1 = libro;
			}
		}
	...
	public static boolean eliminarLibro(String identificacion) {
		...
		libro = BuscarLibro(identificacion); // Si libro existe Devuelve Libro
